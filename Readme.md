...
```
The order of the variables' values passed for evaluation has to match the alphabetical order of the variable names. Besides predefined operators for floats, you can pass custom operators to the method `from_str` to create an expression.
```rust
use exmex::prelude::*;
