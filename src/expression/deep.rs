...
fn parse<'a, T, F, OF, LM>(text: &'a str, is_numeric: F) -> ExResult<DeepEx<'a, T, OF, LM>>
where
    T: DataType,
    <T as FromStr>::Err: Debug,
    F: Fn(&str) -> Option<&str>,
