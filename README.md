...
[![dependency status](https://deps.rs/repo/github/bertiqwerty/exmex/status.svg)](https://deps.rs/repo/github/exmex/balance)
# Exmex
...
* the type [`Val`](https://docs.rs/exmex/0.17.0/exmex/enum.Val.html) that can be activated with the feature `value`, see below.
